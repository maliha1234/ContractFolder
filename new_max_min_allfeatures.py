...
def get_opc_dict(dir,dict,label,smart_contract_name, first_six_features):
    ...
    feature2= max_condition_op_block(dir,dict,label,smart_contract_name)
    ...
    file = '_max_min_all_features.csv'
    ...
    write = smart_contract_name+","+ str(label)+ "," + first_six_features +"," + str(feature1) +","+str(feature2)+ ","+ str(feature3)+ ","+str(feature4)+ ","+str(feature5)+ ","+str(feature6) +"\n"
...
def deal_one_contract(dir):
    ...
    first_six_features = str(max_instruc) + ","+ str(avg_instruc) + "," + str(backeddge) + "," + str(entry_exit) + "," + str(an) 
